...
public class MarkdownContentRenderer implements Renderer {
    ...
    private MarkdownContentRenderer(Builder builder) {
        ...
        this.nodeRendererFactories.add(new MarkdownContentNodeRendererFactory() {
            ...
            public NodeRenderer create(MarkdownContentNodeRendererContext context) {
                return new CoreMarkdownContentNodeRenderer(context);
            }
        });
    }

    /**
     * Create a new builder for configuring an {@link MarkdownContentRenderer}.
     *
     * @return a builder
     */
    ...
    /**
     * Builder for configuring an {@link MarkdownContentRenderer}. See methods for default configuration.
     */
    public static class Builder {

        private boolean stripNewlines = false;
        private List<MarkdownContentNodeRendererFactory> nodeRendererFactories = new ArrayList<>();

        /**
         * @return the configured {@link MarkdownContentRenderer}
         */
        public MarkdownContentRenderer build() {
            return new MarkdownContentRenderer(this);
        }
        ...
        public Builder extensions(Iterable<? extends Extension> extensions) {
            for (Extension extension : extensions) {
                if (extension instanceof MarkdownContentRenderer.MarkdownContentRendererExtension) {
                    MarkdownContentRenderer.MarkdownContentRendererExtension htmlRendererExtension =
                            (MarkdownContentRenderer.MarkdownContentRendererExtension) extension;
    ...
    /**
     * Extension for {@link MarkdownContentRenderer}.
     */
    public interface MarkdownContentRendererExtension extends Extension {
        void extend(MarkdownContentRenderer.Builder rendererBuilder);
    }

    private class RendererContext implements MarkdownContentNodeRendererContext {
        private final MarkdownContentWriter textContentWriter;
        private final NodeRendererMap nodeRendererMap = new NodeRendererMap();

        private RendererContext(MarkdownContentWriter textContentWriter) {
